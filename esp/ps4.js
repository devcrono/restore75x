...
function toggle_payload(pld){
	if(pld == "restore"){
		document.getElementById("progress").innerHTML="Restaurando caché para la Guía del usuario... <font color =\"#F00\">¡¡¡ESPERA !!!</font>";
...
function payload_finished(payload)
{
	if(payload == "binloader"){
		setTimeout(function(){document.getElementById("progress").innerHTML="Esperando enviar el archivo .BIN al puerto 9021"; }, 7000);
	} 
	else{
	    setTimeout(function(){document.getElementById("progress").innerHTML="¡Restauración hecha con <font color=\"#00FF12\">ÉXITO!</font> ¡¡Buenos juegos!!"; }, 7000);
	}
}
