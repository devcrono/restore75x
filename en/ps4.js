...
function toggle_payload(pld){
	if(pld == "restore"){
		document.getElementById("progress").innerHTML="Restoring Cache for User Guide ... <font color=\"#F00\"> WAIT !!! </font>";
...
function payload_finished(payload)
{
	if(payload == "binloader"){
	    ...
	    setTimeout(function(){document.getElementById("progress").innerHTML="Restoration Done With <font color=\"#00FF12\"> SUCCESS !!</font> Good Games!!"; }, 7000);
	}
}
